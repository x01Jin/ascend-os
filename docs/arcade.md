...
- **Pong**: first to 5 against the machine.
- **Dino Run**: survive 20 seconds.
- **Tic-Tac-Toe**: beat the machine once. The machine replies on a random free cell.
- **Snake**: eat 10 pellets with the arrow keys. Hitting a wall or yourself resets the run.
- **Memory**: clear all 6 pairs.
