  ...
  const renderIcon = () => {
    ...
    switch (shortcut.appId) {
      case AppId.EXPLORER:
        return (
          <div
            className={`${commonClasses} bg-blue-500/20 border-blue-500/30 group-hover:bg-blue-500/40`}
          >
      ...
      case AppId.UPDATES:
        return (
          <div
            className={`${commonClasses} bg-purple-500/20 border-purple-500/30 group-hover:bg-purple-500/40`}
          >
      ...
      case AppId.HELP:
        return (
          <div
            className={`${commonClasses} bg-green-500/20 border-green-500/30 group-hover:bg-green-500/40`}
          >
      ...
      default:
        return (
          <div
            className={`${commonClasses} bg-gray-500/20 border-gray-500/30 group-hover:bg-gray-500/40`}
          >
